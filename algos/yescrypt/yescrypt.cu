...
int scanhash_yescryptr24(int thr_id, struct work* work, uint32_t max_nonce, unsigned long* hashes_done)
{
	return  scanhash_yescrypt_base(thr_id, work, max_nonce, hashes_done, 4096, 24, 1, "Jagaricoin", 10);
}

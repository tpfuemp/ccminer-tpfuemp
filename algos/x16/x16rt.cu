/**
 * X16RT algorithm (X16R with the chain order derived from the block timestamp)
 *
 * The hash order comes from sha256d of the ntime masked to a 128-second window
 * (x16rt_getTimeHash), not from the previous block hash.
 *

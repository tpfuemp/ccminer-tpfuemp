...
family-wide naming pass; every family has since migrated, so it is now purely a
churn decision over those ~40 call sites rather than a migration dependency —
still deferred.

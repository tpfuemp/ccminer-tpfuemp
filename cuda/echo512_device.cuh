 ...
 * formulation over the x11/cuda_x11_aes.cuh tables (static-init).
 *
 ...
 * (x16/cuda_x16_echo512_64.cu, tribus/cuda_echo512_aes.cuh tables) is a
 ...
 * tribus/cuda_echo512_aes.cuh + x16/cuda_x16_echo512_64.cu. Its own AES

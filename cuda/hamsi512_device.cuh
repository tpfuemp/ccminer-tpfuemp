 ...
 *
 * NOTE: the SBOX/HAMSI_L/ROUND_BIG/P_BIG/PF_BIG/T_BIG and hamsi_s* macros
 * stay exported (no #undef) because the 80-byte first-stage kernel in the
 * consuming file still expands them. Include this header LAST in fused TUs.
 *
...
#ifndef CUDA_HAMSI512_DEVICE_CUH
#define CUDA_HAMSI512_DEVICE_CUH
...
/* Hamsi-512 of a 64-byte input, in place, d_hash word order in and out —
 * the donor x13_hamsi512_gpu_hash_64 kernel's interior, verbatim. */
__device__ __forceinline__
void hamsi512_hash_64(uint32_t *Hash)
{
